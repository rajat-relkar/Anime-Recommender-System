...
class AnimeRecommendationPipeline:
    def __init__(self,persist_dir="chroma_db"):
        try:
            ...
            vector_builder = VectorStoreBuilder(csv_path="" , persist_dir=persist_dir) # creates new vector store if not present

            retriever = vector_builder.load_vector_store().as_retriever() # if vector store already exists, load it
